...
import com.dou361.live.ui.adapter.NearbyAdapter;
 ...
 * ========================================
 */
public class NearbyLiveFragment extends BaseFragment implements OnItemClickRecyclerListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        NearbyAdapter adapter = new NearbyAdapter(getActivity(), TestRoomLiveRepository.getLiveRoomList());
