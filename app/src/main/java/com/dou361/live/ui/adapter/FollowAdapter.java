...
import com.dou361.live.ui.holder.FollowItemHolder;
...
public class FollowAdapter extends BaseRecyclerViewAdapter<LiveRoom> {
    ...
    public FollowAdapter(Context mContext, List<LiveRoom> mDatas) {
        super(mContext, mDatas);
    }

    @Override
    public BaseViewHolder getItemHolder(Context mContext, OnItemClickRecyclerListener listener, ViewGroup parent) {
        return new FollowItemHolder(mContext, listener, LayoutInflater.from(mContext).
                inflate(R.layout.holder_item_follow, parent, false));
    }
}
